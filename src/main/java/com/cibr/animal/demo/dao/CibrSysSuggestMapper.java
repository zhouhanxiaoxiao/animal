...
public interface CibrSysSuggestMapper {
     ...
     * @mbggenerated
     */
    List<CibrSysSuggest> selectByExampleWithBLOBs(CibrSysSuggestExample example);
     ...
     * @mbggenerated
     */
    int updateByExampleWithBLOBs(@Param("record") CibrSysSuggest record, @Param("example") CibrSysSuggestExample example);
     ...
     * @mbggenerated
     */
    int updateByPrimaryKeyWithBLOBs(CibrSysSuggest record);
    ...
    List<CibrSysSuggest> selectAllReply(@Param("flag") String flag);
}